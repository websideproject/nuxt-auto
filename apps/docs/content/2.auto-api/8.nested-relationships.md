...
![The playground's include builder: author fields id and name selected, limit 2, the generated query /api/posts?include=author[id,name]&limit=2, and the response with each post's author reduced to id and name](/screenshots/api-nested-relations-1440.png)
