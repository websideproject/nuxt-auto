...
export default defineNuxtConfig({
  ...
  nitro: {
    preset: 'cloudflare_module' // exposes the bindings on globalThis.__env__
  }
})
```
...
Nothing to revert: the engine is the second argument of `initializeDatabase()` in the plugin above, not a module
option. Switch the Nitro preset back if you changed it.
