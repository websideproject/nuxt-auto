...
M2M relations appear as cards below the main form, each saved on its own:

![The edit form of an article: the article's own fields with Save and Cancel, then a Categories card with a multi-select showing Technology and a Save Categories button, then a Tags card showing TypeScript and Nuxt with a Save Tags button](/screenshots/admin-edit-1440.png)
...
- [Form Fields](/auto-admin/form-fields-widgets) - Customizing form fields
- [Permissions](/auto-admin/permissions) - Controlling access
- [Configuration & Theming](/auto-admin/configuration-theming) - Modal vs page mode
