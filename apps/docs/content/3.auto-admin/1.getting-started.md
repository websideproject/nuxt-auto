...
![The Articles list page: a table with Id, Title, Published and Created At columns, a Yes/No badge for the boolean column, a row actions menu per row and a Create New button](/screenshots/admin-list-1440.png)
