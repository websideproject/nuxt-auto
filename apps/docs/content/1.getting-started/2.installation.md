...
This guide will help you install and set up Nuxt Auto in your Nuxt project.
...
- **Node.js** 20 or later
- **Nuxt 4** — Nuxt 5 is tested against the nightly builds in CI, but not yet supported for production
