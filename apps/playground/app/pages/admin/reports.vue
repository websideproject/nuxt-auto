  ...
  <div class="space-y-6">
    ...
    <div class="flex items-start justify-between">
      ...
      <UButton
        ...
        @click="createReportModalOpen = true"
      >
        Generate New Report
      </UButton>
    </div>
        ...
        >
          <div class="flex items-center gap-4 flex-1 min-w-0">
            <div
              ...
              :class="report.statusColor"
            >
              <UIcon
                :name="report.statusIcon"
                class="h-5 w-5"
              />
            </div>
          ...
          <div class="space-y-4">
            <div>
              ...
              <USelectMenu
                ...
                :options="reportTypes.map(r => ({ label: r.title, value: r.id }))"
              />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
